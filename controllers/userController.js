...
const userController = {
  ...
  disableUser: async (req, res) => {
    try {
      ...
      // Lógica para inhabilitar un usuario (cambiar su estado a "inhabilitado")
      const disabledUser = await User.findByIdAndUpdate(userId, { estado: 'inhabilitado' }, { new: true });
